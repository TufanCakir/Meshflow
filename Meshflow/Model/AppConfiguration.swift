    ...
    static let fallback = AppConfiguration(
        ...
        translations: [
            "de": [
                ...
                "pick_source": "Auswaehlen",
                "pick_file": "Datei waehlen",
                "pick_photo": "Foto waehlen",
                "drop_title": "Datei hier ablegen",
                "drop_subtitle":
                    "JPG, PNG, HEIC, TIFF, BMP, SCN, DAE, USDZ, OBJ, STL",
                "no_file": "Keine Datei",
                "no_file_selected": "Keine Datei ausgewaehlt",
                "pick_or_drop_file": "Waehle eine Datei oder ziehe sie hinein.",
